...
\hline
\cellcolor{red!25}  0 & \cellcolor{red!25} 0, 1 & $f_1$\\
\cellcolor{Aquamarine!25}  1 & \cellcolor{Aquamarine!25} 2, 3, 4 & $f_2$\\
\cellcolor{pink!25}  2 & \cellcolor{pink!25} 5, 6 & $f_3$\\
...
\hline
\cellcolor{red!25}  0 & \cellcolor{red!25} 0, 1 & $f_1$ \\
\cellcolor{pink!25}  1 & \cellcolor{pink!25} 5, 6 & $f_3$ \\
\cellcolor{green!25}  2 & \cellcolor{green!25} 2, 4 & $f_2$ \\
\cellcolor{cyan!25}  3 & \cellcolor{cyan!25} 3 & $f_2$ \\
\hline
\end{tabular}
\end{table}
...
QWG & Qubits & Frequency Group\\
\hline
\cellcolor{red!25}  0 & \cellcolor{red!25} 1, 2, 3, 13, 14, 15 & $f_1$\\
\cellcolor{pink!25}  1 & \cellcolor{pink!25} 7, 8, 9 & $f_3$\\
\cellcolor{Aquamarine!25}  2 & \cellcolor{Aquamarine!25} 0, 4, 5, 6, 10, 11, 12 16 & $f_2$\\
\hline
\end{tabular}
\end{table}
%\end{minipage}
...
\cellcolor{red!25}  0 & \cellcolor{red!25} 1, 2, 3, 13, 14, 15 & $f_1$\\
\cellcolor{pink!25}  1 & \cellcolor{pink!25} 7, 8, 9 & $f_3$\\
\cellcolor{green!25}  2 & \cellcolor{green!25} 4, 6, 10, 12 & $f_2$\\
\cellcolor{cyan!25}  3 & \cellcolor{cyan!25} 0, 5, 11, 16 & $f_2$\\
\hline
\end{tabular}
\end{table}
