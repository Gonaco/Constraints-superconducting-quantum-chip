...
\begin{table}[bth!]
\centering
\caption{The gate time for the universal set allowed in the devices \{R_x,R_y,CZ,Mz\}.} 
...
QWG & Qubits\\
\hline
\cellcolor{red!25}  0 & \cellcolor{red!25} 0, 1\\
\cellcolor{Aquamarine!25}  1 & \cellcolor{Aquamarine!25} 2, 3, 4\\
\cellcolor{pink!25}  2 & \cellcolor{pink!25} 5, 6\\
...
\hline
\cellcolor{red!25}  0 & \cellcolor{red!25} 0, 1\\
\cellcolor{pink!25}  1 & \cellcolor{pink!25} 5, 6\\
\cellcolor{green!25}  2 & \cellcolor{green!25} 2, 4\\
\cellcolor{cyan!25}  3 & \cellcolor{cyan!25} 3\\
\hline
\end{tabular}
\end{table}
...
QWG & Qubits\\
\hline
\cellcolor{red!25}  0 & \cellcolor{red!25} 1, 2, 3, 13, 14, 15\\
\cellcolor{pink!25}  1 & \cellcolor{pink!25} 7, 8, 9\\
\cellcolor{Aquamarine!25}  2 & \cellcolor{Aquamarine!25} 0, 4, 5, 6, 10, 11, 12 16\\
\hline
\end{tabular}
\end{table}
%\end{minipage}
...
\cellcolor{red!25}  0 & \cellcolor{red!25} 1, 2, 3, 13, 14, 15\\
\cellcolor{pink!25}  1 & \cellcolor{pink!25} 7, 8, 9\\
\cellcolor{green!25}  2 & \cellcolor{green!25} 4, 6, 10, 12\\
\cellcolor{cyan!25}  3 & \cellcolor{cyan!25} 0, 5, 11, 16\\
\hline
\end{tabular}
\end{table}
